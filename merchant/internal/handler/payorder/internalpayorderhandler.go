...
func InternalPayOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InternalPayOrderRequest
		...
		l := payorder.NewInternalPayOrderLogic(r.Context(), ctx)
		resp, err := l.InternalPayOrder(&req)
		if err != nil {
