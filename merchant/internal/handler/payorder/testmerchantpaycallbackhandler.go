...
func TestMerchantPayCallBackHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TestMerchantPayCallBackRequest
		...
		l := payorder.NewTestMerchantPayCallBackLogic(r.Context(), ctx)
		resp, err := l.TestMerchantPayCallBack(&req)
		if err != nil {
